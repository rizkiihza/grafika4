...
int main() {
	...
	*/
	...
	point* charpoints;
	printf("tes2\n");
	int pivot_x = (int)(vinfo.xres)/2;
	int pivot_y = (int)(vinfo.yres)/2;
	printf("tes3 %d %d\n", pivot_x, pivot_y);
	draw(charpoints, "pesawat_tampak_depan.txt", pivot_x, pivot_y);
	printf("tes4\n");
